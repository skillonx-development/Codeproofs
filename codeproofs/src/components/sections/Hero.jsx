  ...
  return (
    <div className="relative min-h-screen bg-black flex flex-col">
      ...
      <div className="container mx-auto px-6 flex-grow flex items-center relative z-10 grid md:grid-cols-2 gap-12">
        ...
        >
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-4 shadow-2xl">
            {/* Code Editor Mockup */}
            <div className="relative w-full aspect-video bg-gray-900 rounded-lg overflow-hidden border-2 border-blue-600/30">
              ...
              <div className="relative z-10 p-4 text-green-400 font-mono text-sm">
                <div>{'>'} Transforming digital landscapes</div>
                <div className="text-blue-300">{'>'} Crafting innovative solutions</div>
                <div className="text-purple-400">{'>'} Pushing technological boundaries</div>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      >
        ...
        >
          <Monitor className="text-green-400 opacity-50" size={48} />
        </motion.div>
      </motion.div>
    </div>
  );
